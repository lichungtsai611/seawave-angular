...
FILES_TO_COPY=(
  ...
  "seawave-angular/package.json"
  "seawave-angular/package-lock.json"
  "seawave-angular/src"
  "seawave-angular/angular.json"
  "seawave-angular/tsconfig.json"
  "seawave-angular/tsconfig.app.json"
)
